...
use app\admin\model\AdminMailLog;
use app\admin\model\ExcelExample;
...
class ExtendController extends Base
{
    protected $extendUrl = [
        [
            'id'    => 1,
    ...
    public function excel()
    {
        if ($this->request->isPost()) {
            ...
            if ($info) {
                ...
                $excel_examples = new ExcelExample();
